...
animal name in front of the habitats. Populate the 
displayNames array with only the animal_name and scientific_name
of each animal. displayNames will be an array of strings,
and each string should follow this pattern: 
...
names (animal_name only) converted to lower case. 
...
the .reduce() method. Remember the reduce method takes 
